...
# Zoom
Echolab uses Microsoft Teams as the standard platform for online meetings. Install the software and be familiar with it. It has many convenience functions (sharing screen, whiteboard, recording, etc.)
# Google Drive
