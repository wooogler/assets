...
# Zoom
Microsoft Teams is the conference call software we are going to use for online meetings. Install the software and be familiar with it. It has many convenience functions (sharing screen, whiteboard, recording, etc.)
# Google Drive
