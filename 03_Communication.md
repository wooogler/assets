...
# Zoom
[Microsoft Teams](https://teams.microsoft.com) is the standard platform our team uses for conducting online meetings. Install the software and be familiar with it. It has many convenience functions (sharing screen, whiteboard, recording, etc.)
# Google Drive
